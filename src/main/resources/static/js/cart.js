...
$(function() {
    ...
    $("#orderProduct").on("click", function() {
        var url = "/order/order?item_name=" + brandList + "&quantity=" + countList + "&total_amount=" + $("#total").text() + "&psid=" + psidList;
        location.href = url;
        /*debugger
        $.ajax({
              type: "GET",
              url: "/order/pay?cid=TC0ONETIME&partner_order_id=1001&partner_user_id=itsme&item_name=TEST11&quantity=22&total_amount=1000&tax_free_amount=0&return_state=2",
              ...
              localStorage.setItem("psidList", psidList);
              localStorage.setItem("mid", sendMid);
